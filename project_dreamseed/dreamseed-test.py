...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, key_modifiers):
        ...
        elif self.difficulty_menu_open and 1000 > x > 600 and 450 > y > 350:
            self.difficulty_menu_open = False

        elif self.upgrade_menu_open and 125 > x > 75 and 675 > y > 625:
            print("Fire 1 selected")
            self.fire1_purchased = True

        # check selected spell and draw spell at caster location
        if not self.main_menu_open and not self.difficulty_menu_open and not self.difficulty_menu_open:
